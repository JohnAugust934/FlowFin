...
- 2.7 1ª entrega (commit 1e928cd) aprovada na essência pelo usuário; follow-up despachado (mesma branch/log) com 3 ajustes: (1) item de transação no mobile menos espremido/mais bonito; (2) donut do dashboard mais elegante no mobile; (3) topo usar x-brand-icon (ícone) em vez de x-brand-logo (logo c/ texto) — logo completa só em telas com espaço (guest/login). Não-mesclar antes da validação visual (design subjetivo).
