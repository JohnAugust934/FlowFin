                ...
                <div class="glass-row shadow-card px-4 py-3 flex items-center gap-3">
                    ...
                    <div class="text-right shrink-0">
                        <p class="font-semibold"
                           :class="tx.type === 'entrada' ? 'text-emerald-600' : 'text-danger'"
                    ...
                    <div class="flex items-center gap-1 shrink-0">
                        <template x-if="confirmingId !== tx.id">
                            <div class="flex items-center gap-1">
                                <button type="button" @click="editTransaction(tx)" class="p-2 text-neutral-400 hover:text-brand-600" aria-label="Editar">
                                ...
                                <button type="button" @click="confirmDelete(tx.id)" class="p-2 text-neutral-400 hover:text-danger" aria-label="Excluir">
                        ...
                        <template x-if="confirmingId === tx.id">
                            <div class="flex items-center gap-1">
                                <button type="button" @click="remove(tx.id)" :disabled="deleting" class="btn-danger px-2 py-1 text-xs">Excluir</button>
