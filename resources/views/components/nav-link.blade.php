...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-brand-600 text-sm font-semibold leading-5 text-neutral-900 focus:outline-none transition duration-150 ease-in-out'
